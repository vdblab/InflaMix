...
1. scaling_sfig3.R
2. modelgen_fig2h_i.R
3. icl_bic_efig2a.R
4. efig2b_g.R
5. deriv_cohort_properties_fig1a_g_sfig2.R
6. deriv_outcomes_fig1h_l_table2.R
7. validation_fig2c_k_fig3d_l_efig4_table2.R
8. exploratory_analyses_MTV_table2.R

All packages and version information is included in the renv.lock lockfile. 
